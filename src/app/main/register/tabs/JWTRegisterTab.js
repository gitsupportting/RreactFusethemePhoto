...
class RegisterPage extends Component {
    ...
    onSignin = () => {
        let that = this;        
        axios.post(`http://localhost:3000/users/signup`, { name: this.state.name, email: this.state.email, password: this.state.password, role: 1, })
            .then(res => {
                    ...
                    <Card className="w-full max-w-384">
                        ...
                        <CardContent className="flex flex-col items-center justify-center p-32">
                            ...
                            <div className="flex flex-col items-center justify-center pt-32 pb-24">
                                ...
                                <Link className="font-medium" to="/photographer/login">Login</Link>
