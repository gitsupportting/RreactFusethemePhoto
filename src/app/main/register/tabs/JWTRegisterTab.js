          ...
          <Card className='w-full max-w-384'>
            <CardContent className='flex flex-col items-center justify-center p-32'>
              ...
              >
                ...
                {/* <TextField
                  className='mb-16'
                  label={translations[this.state.selectedLan]['_PHONE']}
                  type='phone'
                  name='phone'
                  value={phone}
                  onChange={this.handleChange}
                ...
                <TextField
                  className='mb-16'
                  label={
                    translations[this.state.selectedLan]['_PASSWORD_CONFIRM']
                  }
                  type='password'
              ...
              <div className='flex flex-col items-center justify-center pt-32 pb-24'>
                ...
                <Link className='font-medium' to='/photographer/login'>
                  {translations[this.state.selectedLan]['_LOGIN_R']}
                </Link>
